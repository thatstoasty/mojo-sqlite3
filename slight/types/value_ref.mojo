...
alias InvalidColumnTypeError = Error("InvalidColumnType: Unsupported value type")
...
struct ValueRef[stmt: Origin]:
    ...
    alias _type = Variant[SQLite3Null, SQLite3Integer, SQLite3Real, SQLite3Text[stmt], SQLite3Blob[stmt]]
